var counter = 0;
/**
 * Untuk mengelompokkan data Detail PO (Purchase Order). Ini merupakan data detail yang berulang-ulang.
...
function PoDetail(cloned, data) {
    ...
    this.PrDetailId = cloned.find("#PrDetailId");
...
PoDetail.prototype.AssignData = function(data) {
    ...
    this.Id.val(data.Id);
    this.Codes.val(temp);
    this.PrDetailId.val(data.PrDetailId);
 ...
 * @event
 */
PoDetail.prototype.Category_Change = function(sender, e) {
    if (sender.value == "") {
 ...
 * @event
 */
PoDetail.prototype.InvId_Change = function(sender, e) {
