/**
 * Untuk mengelompokkan data Detail Item Issue. Ini merupakan data detail yang berulang-ulang.
...
function IsDetail(cloned, data) {
    ...
    // Event Registration
    var self = this;    // Diperlukan reference ke instance object IsDetail karena pada event handler this sudah refer ke object yang invoke event
...
IsDetail.prototype.AssignData = function(data) {
 ...
 * @event
 */
IsDetail.prototype.Category_Change = function(sender, e) {
    if (sender.value == "") {
 ...
 * @event
 */
IsDetail.prototype.InvId_Change = function(sender, e) {
