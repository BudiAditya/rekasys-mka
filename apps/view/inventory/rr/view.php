...
?>
<head>
    <title>REKASYS | R/R Review</title>
...
?>
<br />
<div id="p" class="easyui-panel" title="R/R Review" style="width:100%;height:100%;padding:10px;" data-options="footer:'#ft'">
            ...
            if (PrStatus == 1) {
                if (PrId > 0) {
                    if (confirm("Hapus Data R/R ini?")) {
                        location.href = "<?php print($helper->site_url("inventory.rr/delete/")); ?>" + PrId;
                    }
                }
            }else{
        ...
        $("#bCetak").click(function(e){
            if (PrId > 0) {
                if (confirm("Cetak Data R/R ini?")) {
                    location.href = "<?php print($helper->site_url("inventory.rr/doc_print/pdf?&id[]=")); ?>" + PrId;
                }
            }
        });
