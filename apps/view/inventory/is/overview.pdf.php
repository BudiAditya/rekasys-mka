...
$pdf->SetColumns(
    array("No", "Company", "Departemen", "No. Dokumen", "Tgl. Issue", "Status", "Tgl. Update"),
    array(11, 15, 30, 35, 30, 28, 30)
);
...
$pdf->Cell(290,7,'REKAPITULASI DOKUMEN ITEM ISSUE',0,0,'L');
$pdf->Ln();
...
$pdf->Ln();
$pdf->Cell(25, 7, 'Departemen', 0, 0, 'L');
$pdf->Cell(3, 7, ':', 0, 0, 'L');
$pdf->Cell(100, 7, $deptName, 0, 0, 'L');
$pdf->Ln();
...
while($rs = $report->fetch_assoc()) {
    ...
    $pdf->RowData(array($i, $rs["entity"], $rs["dept"], $rs["doc_no"], date('d M Y', strtotime($rs["issue_date"])), $rs["status_name"], $updated), 5, null, 0,  array("C", "L", "L", "L", "L", "L", "L"));
}
$pdf->Output("Rekap dokumen Item Issue.pdf", "D");