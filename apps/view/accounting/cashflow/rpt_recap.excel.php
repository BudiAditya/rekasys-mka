...
$phpExcel->getProperties()->setCreator("Reka System (c) Wayan Budiasa")->setTitle("Rekap Cash-Bank Per Akun")->setCompany("Rekasys Corporation");

$sheet = $phpExcel->getActiveSheet();
$sheet->setTitle("Rekap Cash-Bank Per Akun");
...
$sheet->setCellValue("A2", "Rekap Cash Flow Per Akun");
...
header(sprintf('Content-Disposition: attachment;filename="rekap-cashbank-%s %s.xls"', $monthNames[$month], $year));
