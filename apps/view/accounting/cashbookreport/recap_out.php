...
switch ($output) {
    case "xls":
        ...
        include("recap_out.excel.php");
        break;
	case "pdf":
		require_once(LIBRARY . "tabular_pdf.php");

		class CashbookRecapOutReportPdf extends TabularPdf {
			private $company;
			private $monthName;
			private $year;
			...
			public function Header() {
				...
				$this->SetFont("Arial","",11);
				$this->Cell(400, 5, "Rekap Cash/Bank Out Per Akun");
				$this->SetFont("Arial","",11);
				$this->SetX(-70, true);
		...
		include("recap_out.pdf.php");
		break;
	default:
		include("recap_out.web.php");
		break;
}

// End of File: recap_out.php
