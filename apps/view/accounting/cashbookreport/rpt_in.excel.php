...
$phpExcel->getProperties()->setCreator("Reka System (c) Wayan Budiasa")->setTitle("Report Cash-Bank In")->setCompany("Rekasys Corporation");

$sheet = $phpExcel->getActiveSheet();
$sheet->setTitle("Report Cash-Bank In");
...
$sheet->setCellValue("A2", "Jurnal Cash-Bank In");
...
header(sprintf('Content-Disposition: attachment;filename="jurnal-cashbank-in.xls"'));
