...
$phpExcel->getProperties()->setCreator("Reka System (c) Wayan Budiasa")->setTitle("Rekap Cash-Bank Out Per Akun")->setCompany("Rekasys Corporation");

$sheet = $phpExcel->getActiveSheet();
$sheet->setTitle("Rekap Cash-Bank Out Per Akun");
...
$sheet->setCellValue("A2", "Rekap Cash/Bank Out Per Akun");
...
header(sprintf('Content-Disposition: attachment;filename="rekap-cashbank-out-%s %s.xls"', $monthNames[$month], $year));
