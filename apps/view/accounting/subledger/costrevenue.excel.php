...
$phpExcel->getProperties()->setCreator("Reka System (c) Wayan Budiasa")->setTitle("CostRevenue")->setCompany("Rekasys Corporation");
...
if($parentId == "4"){
   $sheet->setCellValue("A2", "Report Pendapatan");
}else{
   $sheet->setCellValue("A2", "Report Biaya-biaya");
}
...
header(sprintf('Content-Disposition: attachment;filename="costrevenue-%s.xls"', $parentId));
