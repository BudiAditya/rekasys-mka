...
?>
<head>
    <title>REKASYS | P/R Approval Process</title>
...
?>
<br />
<div id="p" class="easyui-panel" title="P/R Approval Process" style="width:100%;height:100%;padding:10px;" data-options="footer:'#ft'">
    <table cellpadding="0" cellspacing="0" class="tablePadding" align="left" style="font-size: 13px;font-family: tahoma">
        ...
        <tr>
            <td colspan="9">
                <form action="<?php print($helper->site_url("purchase.pr/process/" . $pr->Id)); ?>" method="post">
                    <table cellpadding="0" cellspacing="0" class="tablePadding tableBorder" align="left" style="font-size: 12px;font-family: tahoma">
                        <tr>
                            <th colspan="10">P/R Detail</th>
                        </tr>
                        <tr>
                            <th>No.</th>
                            <th>MR Number</th>
                        ...
                        foreach($pr->Details as $idx => $detail) {
                            ...
                            printf('<td class="right"><input type="text" class="right" id="Price1_%d" name="Price1[]" size="10" value="%d" %s/></td>',$idx,$detail->Price1,$pr->StatusCode > 3 ? 'readonly' : '');
                            print("<td>");
                            printf("<select name='SupplierId1[]' id='SupplierId1_%d' %s>",$idx,$pr->StatusCode > 3 ? 'disabled' : '');
                        ...
                        <tr>
                            <td colspan="10" valign="middle" align="right">
                                <?php if ($pr->StatusCode < 4){ ?>
                                <button type="submit">PROCESS</button>
                                &nbsp;&nbsp;&nbsp;
                                <?php } ?>
                                <a href="<?php print($helper->site_url("purchase.pr")); ?>">P/R List</a>
                            </td>
                        </tr>
                    </table>
                </form>
