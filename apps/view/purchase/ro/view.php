...
?>
<head>
    <title>REKASYS | R/O Review</title>
...
?>
<br />
<div id="p" class="easyui-panel" title="R/O Review" style="width:100%;height:100%;padding:10px;" data-options="footer:'#ft'">
        ...
        <tr>
            <td colspan="9">
                <table cellpadding="0" cellspacing="0" class="tablePadding tableBorder" align="left" style="font-size: 12px;font-family: tahoma">
                    <tr>
                        <th colspan="10">Repair Order Detail</th>
                    </tr>
                    <tr>
                        <th>No.</th>
                        <th>PR Number</th>
