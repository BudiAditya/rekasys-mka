...
?>
<br />
<div id="p" class="easyui-panel" title="Add New Employee" style="width:100%;height:auto;padding:5px;" data-options="footer:'#ft'">
    <form id="frm" action="<?php print($helper->site_url("hr.employee/add")); ?>" method="post" enctype="multipart/form-data" novalidate>
    <table cellpadding="1" cellspacing="1" align="left" style="font-size: 12px;font-family: tahoma">
        ...
        <tr>
            ...
            <td colspan="2"><input class="easyui-textbox" style="width: 110px" id="NmIbuKandung" name="NmIbuKandung" value="<?php print($employee->NmIbuKandung);?>"/></td>
        </tr>
        <tr>
