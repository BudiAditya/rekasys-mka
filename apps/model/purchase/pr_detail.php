...
class PrDetail extends EntityBase {
	public $Id;
	public $PrId;
	public $Sequence;
	public $ItemId;
	...
	public function LoadById($id) {
		$this->connector->CommandText = "SELECT a.* From vw_ic_pr_detail AS a WHERE a.id = ?id";
	...
	public function LoadByPrId($prId, $orderBy = "a.item_code") {
		$this->connector->CommandText = "SELECT a.* From vw_ic_pr_detail AS a WHERE a.pr_master_id = ?id ORDER BY $orderBy";
...
"INSERT INTO ic_pr_detail(pr_master_id, item_id, mr_detail_id, qty, item_description, uom_cd, supplier_id_1, price_1, supplier_id_2, price_2, supplier_id_3, price_3, selected_supplier, date_1, date_2, date_3)
VALUES (?prId, ?itemId, ?mrDetId, ?qty, ?itemDesc, ?uomCd, ?supp1, ?price1, ?supp2, ?price2, ?supp3, ?price3, ?selSupp, ?date1, ?date2, ?date3)";

		$this->connector->AddParameter("?prId", $this->PrId);
...
WHERE id = ?id";
	...
	public function Delete($id) {
		$this->connector->CommandText = "DELETE FROM ic_pr_detail WHERE id = ?id";
		$this->connector->AddParameter("?id", $id);
    ...
    public function Approve($id) {
        $this->connector->CommandText = "UPDATE ic_pr_detail a SET a.price_1 = ?price, a.supplier_id_1 = ?supplier, a.selected_supplier = 1 WHERE id = ?id";
